...
function createSession(name) {
  ...
  return {
    ...
    // its neighbours. Values are single-quoted (with the standard '"'"'
    // escape for embedded quotes); names are validated against the
    // POSIX-portable class rather than quoted, since a name that needs
    // quoting is a bug in the caller, not a case to support.
