...
// The word-wrap this screen's description/comment bodies use lives in
// lib/ui/textwrap.js now (extracted so drilldown.js's TICKET panel does not
// duplicate it) — kept as a local `wrap` alias so the rest of this file
// (commentBlock, renderTicketView) is unchanged.
const wrap = textwrap.wrap;
