...
async function watch(opts) {
  ...
  function currentState() {
    return { mode, runs, selected, prompt, escalationTicket, escalationReply, escalationNotice };
  }
  ...
  await new Promise((resolve) => {
    ...
    // see store.js). A refusal — "already answered", or a permissions/IO
    // failure — stays on the escalation screen and is shown, not swallowed.
