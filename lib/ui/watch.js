...
// buildFrame, attachAndRestore and computeLiveEscalations are exported
// alongside watch() purely for test/watch.test.js (CON-17 / CON-25) —
// watch() itself runs an interval loop against real stdin/stdout, so the
// pure logic is what gets unit tests; watch()'s own runtime behavior is
