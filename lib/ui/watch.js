    ...
    function promptKey(key) {
      ...
      if (key === '\r' || key === '\n') {
        ...
        try {
          ...
          // Report it on the screen the user is already looking at: an
          // unhandled throw here would take the whole dashboard down — losing
          // sight of every other run — over one mistyped ticket.
          prompt.error = 'could not start ' + ticket + ': ' +
