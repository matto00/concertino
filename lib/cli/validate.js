...
// the TUI's existing single-issue fetch rather than a second GraphQL
// client — only required here, in the one command module that needs it, not
// at module scope in lib/config.js, since lib/config.js stays
// side-effect-free / dependency-free by design.
const { fetchOneTicket } = require('../ui/linear');
const { green, yellow, gray, red, dim, section, read, exists, resolveOut, resolveConfigPath } = require('./shared');
