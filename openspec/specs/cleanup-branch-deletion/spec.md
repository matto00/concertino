# cleanup-branch-deletion Specification

## Purpose
cleanup.sh --phase4 deletes the ticket's merged local and remote branch by content-equality against the fetched base, never by merge-ancestry, and only after the worktree using it has been removed.
## Requirements
