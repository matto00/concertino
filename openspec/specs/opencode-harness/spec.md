...
## Purpose
Defines OpenCode as a third first-class rendered harness — sync, validate,
doctor, eject, diff, upgrade, and completions all support it at parity with
Claude Code and Codex, without changing default behavior for projects that
don't opt in.
