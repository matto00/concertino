# fleet-metrics-spend Specification

## Purpose
Defines METRICS' fleet-wide spend today/week line — summed from `run.cost` telemetry — and its honest degradation (an explicit reporting-coverage fraction) whenever any run in the window lacks cost data.
## Requirements
