# ticket-priority Specification

## Purpose
Defines how a ticket's Linear priority is fetched, normalised, cache-migrated, rendered as a column, and sorted on the launch pad, so a stale or missing value is never rendered as if it were the real "None" priority.
## Requirements
